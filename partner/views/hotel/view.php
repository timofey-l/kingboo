            ...
            <?php foreach ($rooms as $index => $room): ?>
                ...
                <div class="row rooms-list">
                    <div class="col-sm-3 col-md-2 col-lg-1">
                        <?php if ($room->images): ?>
                        <div id="room-images-carousel-<?= $room->id ?>" class="carousel slide" data-ride="carousel">
                            <!-- Wrapper for slides -->
                            <div class="carousel-inner" role="listbox">
                            ...
                            <!-- Controls -->
                            <a class="left carousel-control" href="#room-images-carousel-<?= $room->id ?>" role="button"
                               data-slide="prev">
                                <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
                                <span class="sr-only">Previous</span>
                            </a>
                            <a class="right carousel-control" href="#room-images-carousel-<?= $room->id ?>" role="button"
                               data-slide="next">
                                <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
                                <span class="sr-only">Next</span>
                            </a>
                    ...
                    <div class="col-sm-9 col-md-10 col-lg-11 text-muted">
                        ...
                        <br/>
                        <?= \Yii::t('rooms', 'Adults') ?>: <strong class="label label-default"><?= $room->adults ?></strong>
                        &nbsp;
                        <?= \Yii::t('rooms', 'Children') ?>: <strong class="label label-default"><?= $room->children ?></strong>
                        &nbsp;
                        <?= \Yii::t('rooms', 'Total') ?>: <strong class="label label-default"><?= $room->total ?></strong>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
