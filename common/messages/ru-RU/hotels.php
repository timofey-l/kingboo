...
return [
    ...
    'Hotel address Ru' => 'Адрес отеля (рус.)',
    'Hotel address En' => 'Адрес отеля (англ.)',
    ...
    'The hotel account will be permanently deleted. If you sure you want to continue type "delete".' => 'Аккаунт отеля будет удален без возможности восстановления. Если вы уверены, что хотите продолжать, напишите &laquo;delete&raquo;.',
