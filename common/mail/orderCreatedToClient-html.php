...
<div>
    ...
    <p><?= \Yii::t($translate_category, 'Order number: {n}', ['n' => $order->number], $lang) ?></p>
    ...
    <p><?= \Yii::t($translate_category, 'To make a payment, please click the link below <br/><a href="{url}">{url}</a>', ['url' => 'http://king-boo.com/payment/'.$order->payment_url], $lang) ?></p>
